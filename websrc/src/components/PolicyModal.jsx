...
const PolicyModal = ({modal, changeModal}) => (
  <Modal size="xl" id="policy-modal" show={modal && modal.open} onHide={() => changeModal({policy: {open: false}})}>
    ...
    <Modal.Body>
      ...
      <p>BlobConverter follows a standard procedure of using log files. These files log visitors when they visit
      ...
      <p>You may consult this list to find the Privacy Policy for each of the advertising partners of BlobConverter.</p>

      <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
        in their respective advertisements and links that appear on BlobConverter, which are sent directly to users'
      ...
      <p>Note that BlobConverter has no access to or control over these cookies that are used by third-party
        advertisers.</p>

      <h2>Third Party Privacy Policies</h2>

      <p>BlobConverter's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
      ...
      <p>BlobConverter does not knowingly collect any Personal Identifiable Information from children under the age of
